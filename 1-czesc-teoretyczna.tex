...
\clearpage\chapter{Przegląd technik pomiarowych i istniejących rozwiązań}
    ...
    potencjalnego nabywcy jest wygoda użytkowania, czyli urządzenie powinno być proste w~instalacji oraz niewymagające serwisowania. Ważną kwestią jest też zapewnienie bezpieczeństwa komunikacji\cite{Wytrebowicz2020_roz}. Na tej podstawie sformułowano następujące główne założenia funkcjonalne i~projektowe
    urządzenia:
