...
\phantomsection\addcontentsline{toc}{chapter}{Wprowadzenie}
    \noindent Rozwój Internetu Rzeczy (ang.\ \textit{Internet of Things}, IOT) jest jednym z~głównych filarów Czwartej Rewolucji Przemysłowej. Z~tego powodu inteligentne urządzenia elektroniczne zyskują coraz
    ...
    takich rozwiązań pozwala nie tylko na automatyzację procesu, ale również na integrację systemów z~innymi urządzeniami w~ramach Internetu Rzeczy.
...
\clearpage\chapter{Przegląd technik pomiarowych i istniejących rozwiązań}
    ...
    potencjalnego nabywcy jest wygoda użytkowania, czyli urządzenie powinno być proste w~instalacji oraz niewymagające serwisowania. Ważną kwestią jest też zapewnienie bezpieczeństwa komunikacji\cite{Wytrebowicz2020_roz}, system powinien uwzględniać wymagania bezpieczeństwa zgodnie z normą ISO/IEC 27404\cite{ISO_IEC_27404_2023}. Na tej podstawie sformułowano następujące główne założenia funkcjonalne i~projektowe
    urządzenia:
